...
For best performance, you might also adjust the blue-and-white potentiometer on the IR sensor board. This will change the sensitivity of the sensors, allowing them to detect the line more reliably. Turn it clockwise to increase sensitivity, or counter-clockwise to decrease it.

![Sensor adjusted for better performance](/images/ir_sensor.png)